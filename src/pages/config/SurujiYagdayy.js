...
const SurujiYagdayy = props =>{
    ...
    useEffect(()=>{
      ...
      setOnline_hire(maglumat && maglumat.onlinePayment_active)
    ...
    const EditStatus = async()=>{
      ...
      axiosInstance.patch("/api/config/update/"+maglumat.id,{
        ...
        onlinePayment_active:online_hire, 
    ...
    return (
        <div
            ...
            <Input style={{width:"90%"}} value={online_hire} onChange={(e)=>{setOnline_hire(e.target.value)}} addonBefore='Online Sowda'  className='suruji-yagdayy--input' />
